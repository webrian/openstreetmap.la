Privacy Policy of www.openstreetmap.la
======================================
...
Unique device identification, which is a session identifier, current center
location and zoom of map view, language setting.
...
automatically when using this Application. Any use of Cookies - or of other
tracking tools - by this Application or by the owners of third party services
used by this Application, unless stated otherwise, serves to identify Users
and remember their preferences, for the sole purpose of providing the service
required by the User.
Failure to provide certain Personal Data may make it impossible for this
Application to provide its services. Users are responsible for any Personal
Data of third parties obtained, published or shared through this Application
and confirm that they have the third party's consent to provide the Data to the
Owner.
...
The Data is kept for the time necessary to provide the service requested by the
User, or stated by the purposes outlined in this document, and the User can
...
Current center location and zoom of map view

This Application may track Users by storing the current center location and
zoom of map view, for storing Users' preferences.

Language setting

This Application may track Users by storing the current language settings,
...
Users have the right, at any time, to know whether their Personal Data has been
stored and can consult the Data Controller to learn about their contents and
...
the Policy, the User must cease using this Application and can request that the
Data Controller removes the Personal Data. Unless stated otherwise, the
...
an association, which is, or can be, identified, even indirectly, by reference
...
fulfillment of the obligations under Art. 10 of EC Directive n. 95/46/EC, and
under the provisions of Directive 2002/58/EC, as revised by Directive
2009/136/EC, on the subject of Cookies.
This privacy policy relates solely to this Application.

Latest update: October 06, 2015
